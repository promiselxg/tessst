...
export function CompetitionDataTable({ columns, data, loading }) {
  ...
  const handleGetSelectedIds = async () => {
    ...
    if (selectedIds.length === 0) {
      toast.error("Please select at least 1 item to delete.");
      return;
    }

    try {
      setIsLoading(true);
      const response = await apiCall("delete", "/competition", {
        ...selectedIds,
      });
