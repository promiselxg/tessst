  ...
  return (
    <>
      <CourseDetailsHeader
        ...
        links={course?.chapters || []}
      />

      <div className="w-full">
        {/* Sidebar */}
        {loading ? (
          <div className="w-[20%] border-r border-gray-200 h-screen hidden md:flex fixed left-0 flex-col justify-between p-4">
            <div className="flex flex-col gap-4">
              {[...Array(3)].map((_, idx) => (
                <Skeleton
                  key={idx}
                  className="h-10 w-full rounded-md bg-slate-200"
                />
              ))}
            </div>
            <div className="w-full absolute bottom-20 left-0 px-4">
              <Skeleton className="h-32 w-full rounded-md bg-slate-200" />
            </div>
          </div>
        ) : (
            ...
            <div className="w-full p-4 absolute bottom-20 left-0">
              <div className="p-5 border rounded-md bg-white text-black">
                ...
                <p className="text-sm text-muted-foreground font-euclid font-thin leading-snug">
                  Unlock all courses, get access to exclusive materials, and
                  more.
                </p>
        ...
        <div className="p-[17px] bg-emerald-950 text-white md:hidden">
          {loading ? (
            <Skeleton className="h-4 w-1/2 bg-slate-400 rounded-md" />
          ) : (
            <BreadcrumbNav
              prev={{
            ...
            {loading ? (
              <>
                <div className="w-full md:w-[65%]">
                  <Skeleton className="w-full h-[300px] bg-slate-300 rounded-md" />
                ...
                <div className="w-full md:w-[35%]">
                  <div className="p-5 border rounded-md bg-muted flex flex-col gap-5">
