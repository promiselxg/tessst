...
const HomePartnerSection = ({ showChild = true }) => {
  return (
    <div
      className={cn(
        `${
          showChild ? "min-h-[calc(100vh-85px)] " : "min-h-fit"
        } w-[90%] mx-auto md:w-full py-[80px] md:pt-[85px] relative`
      )}
    >
                ...
                <div className="w-full md:w-[45%] py-10">
                  ...
                  <TextFadeIn>
                    <p className=" font-euclid py-2 text-sm">
                      Donec aliquam ultrices purus, nec laoreet elit
                      scelerisque. Integer eget nisi ultrices, hendrerit urna
                      at, pulvinar diam. Donec sit amet facilisis dolor nunc
                      eget purus
                    </p>
                  </TextFadeIn>
